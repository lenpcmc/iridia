...
class iridia:
    ...
    def read(self, filename: str, relax = True, **kwargs) -> None:
        self.atoms = ase_read(filename, **kwargs)
    ...
    def get_ddm(self, **kwargs) -> np.ndarray:
        self.ddm = dipoleSpectrumAtoms( self.atoms, self.vibrations, self.verbose, **kwargs )
        return self.ddm
    ...
    def abs(self, w: float, y: float = 0.25, **kwargs) -> float:
